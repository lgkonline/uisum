...
import { Page, Body, Header, HeaderTitle, HeaderActions, Utilities, ActionMenu, ActionMenuItem, ActionMenuSwitch, Search } from "../../../index.dev.js";

import { setTimeout } from "timers";

/**
 * Demonstrates how Bootstrap's default components would look like.
 */
                ...
                <Header>
                    ...
                    <HeaderActions>
                        <ActionMenu>
                            ...
                            />
                            <ActionMenuItem icon="icon-truck" label="Dokumentengruppe löschen" />
                            <ActionMenuItem icon="icon-truck" label="Dokumentengruppe hinzufügen" />
                            <ActionMenuItem icon="icon-truck" label="Dokument löschen" />
                        </ActionMenu>
                    </HeaderActions>
                </Header>
                ...
                <Body containerClass="no-container">
                    ...
                    <div className="jumbotron jumbotron-fluid">
                        <div className="container">
                            <h1 className="display-4">Bootstrap Demo</h1>
                        </div>
                    </div>
